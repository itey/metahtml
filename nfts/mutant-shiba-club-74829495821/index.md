...
Mutant Shiba Club 是 10,000 个动画 NFT 的集合。每个 NFT 都是独一无二的，并且驻留在以太坊区块链上。您的 Mutant Shiba Club NFT 将成为您的俱乐部会员资格。

变种人芝俱乐部 | MSC NFT - 常见问题（FAQ）
▶ 什么是变种柴俱乐部 | MSC？
变种人芝俱乐部 | MSC 是一个 NFT（不可替代代币）集合。存储在区块链上的数字艺术品集合。
▶ 多少突变芝俱乐部 | MSC代币存在吗？
...
拥有 Mutant Shiba Club 的许多用户 | MSC NFT 还拥有 HAKI NFT、 Shinsekaicorp、 Shinsekai Portal和 Los Muertos World。
